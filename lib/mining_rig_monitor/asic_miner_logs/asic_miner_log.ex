defmodule MiningRigMonitor.AsicMinerLogs.AsicMinerLog do
  ...
  def changeset(asic_miner_log, attrs) do
    asic_miner_log
    |> cast(attrs, cast_attr_list())
    |> validate_required(required_attr_list())
  end

  defp cast_attr_list()  do
  ...
  defp required_attr_list()  do
    [:asic_miner_id, :hashrate_5_min, :hashrate_uom, :uptime,
     :pool_1_address, :pool_1_user, :pool_1_state,
     :hashboard_1_temp_1, :fan_1_speed,
     :lan_ip, :coin_name, :power]
  end
end
