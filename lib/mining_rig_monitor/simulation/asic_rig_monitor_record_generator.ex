defmodule MiningRigMonitor.Simulation.AsicRigMonitorRecordGenerator do
  use GenServer
  ...
  def handle_info(:submit_asic_rig_monitor_record, state) do
    ...
    for mining_rig_code <- @asic_rig_code_list do
  ...
  def submit(mining_rig_code, asic_rig_monitor_data) do
    header_list = [
      {"Content-Type", "application/json"},
      {"MINING_RIG_CODE", mining_rig_code}
    ]
